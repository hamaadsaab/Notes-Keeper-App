...
import com.example.appify.recylerview.database.dao;
import com.example.appify.recylerview.database.roomDatabase;
...
public class Repository {
    ...
    private static class UpdateAsyncTask extends AsyncTask<ListItemEntity, Void, Void> {
        private com.example.appify.recylerview.database.dao asyncTaskDao;
